...
public class ViewLeft extends LinearLayout implements ViewBaseAction  {
    ...
    private final String[] items = new String[] { "全部类型", "地推", "餐饮酒店", "零售", "房地产", "教育培训" };//显示字段
    private final String[] childitems = new String[] { "全部", "发单", "推广员", "APP推广"};//显示字段
