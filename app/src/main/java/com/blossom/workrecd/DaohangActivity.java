...
import com.blossom.workrecd.Utils.TTSController;
...
public class DaohangActivity extends Activity implements AMapNaviListener, View.OnClickListener {
    ...
    private void initView(Bundle savedInstanceState) {
        ...
        mtitleview.setRightImageButton(new TitleView.OnRightImageButtonClickLister() {
            @Override
            public void onClick(View button) {
                Intent moreintent = new Intent(DaohangActivity.this, MsgActivity.class);
