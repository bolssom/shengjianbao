...
public class xUtilsImageLoader {//框架里面设置了缓存和异步操作，不用单独设置线程池和缓存机制（也可以自定义缓存路径）
    ...
    public xUtilsImageLoader(Context context) {
        ...
        bitmapUtils.configDefaultLoadingImage(R.mipmap.default_top_pic);//默认背景图片
        bitmapUtils.configDefaultLoadFailedImage(R.mipmap.default_top_pic);//加载失败图片
