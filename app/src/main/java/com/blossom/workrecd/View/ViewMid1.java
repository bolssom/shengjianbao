 ...
 */
public class ViewMid1 extends RelativeLayout implements ViewBaseAction {
    ...
    public ViewMid1(Context context) {
        super(context);
        init(context);
    }
    ...
    public ViewMid1(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public ViewMid1(Context context, AttributeSet attrs, int defStyleAttr) {
