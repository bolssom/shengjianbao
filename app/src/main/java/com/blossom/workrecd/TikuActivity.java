...
public class TikuActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SimpleAdapter simpleAdapter = new SimpleAdapter(
                TikuActivity.this, getData(), R.layout.item_spinner_tiku,
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view,
                ...
                Toast.makeText(TikuActivity.this,
    ...
    private void initview() {
        ...
        mtitleview.setRightImageButton(new TitleView.OnRightImageButtonClickLister() {
            @Override
            public void onClick(View button) {
                Intent moreintent = new Intent(TikuActivity.this, MsgActivity.class);
